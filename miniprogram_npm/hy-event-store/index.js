...
__DEFINE__(1648050681178, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648050681179,"./event-store":1648050681180}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648050681179, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648050681180, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648050681179,"./utils":1648050681181}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648050681181, function(require, module, exports) {
...
return __REQUIRE__(1648050681178);
})()
