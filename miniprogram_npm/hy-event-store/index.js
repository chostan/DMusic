...
__DEFINE__(1648556929315, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648556929316,"./event-store":1648556929317}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648556929316, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648556929317, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648556929316,"./utils":1648556929318}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648556929318, function(require, module, exports) {
...
return __REQUIRE__(1648556929315);
})()
